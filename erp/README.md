...
**Frontend**: Next.js 14+ • TypeScript • Tailwind CSS • Framer Motion • GSAP • Three.js • Recharts

**Backend**: Node.js • Express.js • PostgreSQL • Prisma • JWT • Razorpay • Stripe

**DevOps**: Docker • Nginx • GitHub Actions • Vercel • Railway

---

## 👥 User Roles (11 Total)

1. Super Admin • 2. Admin • 3. Manager • 4. Accountant • 5. Photographer
6. Videographer • 7. Editor • 8. Album Designer • 9. Coordinator • 10. Employee • 11. Customer

---

**Version**: 1.0.0-beta | **Status**: 🚀 Production Ready
